...
@section('content')
    <div class="parallax-window" data-parallax="scroll" data-image-src="{{asset('parallo/img/bg-01.jpg')}}">
    <div class="container-fluid">
      ...
      <section class="row" id="tmHome">
        <div class="col-12 tm-home-container">
          ...
          <div class="tm-home-right">
            <img src="{{asset('parallo/img/mobile-screen.png')}}" alt="App on Mobile mockup" />
          </div>
        </div>
      </section>
      ...
      <section class="row" id="tmCallToAction">
        <div class="col-12 tm-call-to-action-col">
          <img src="{{asset('parallo/img/call-to-action.jpg')}}" alt="Image" class="img-fluid tm-call-to-action-image" />
